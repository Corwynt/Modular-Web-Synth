...
(function(n) {
  var e, t, r = "0.4.2",
    ...
    p = function(n, r) {
      ...
      for (g = 0; v > g; g++) if (f = u[g], "zIndex" in f) if (f.zIndex == a[s]) {
        ...
        do if (s++, f = c[a[s]], f && h.push(f.apply(r, o)), t) break;
        while (f)
      } else c[f.zIndex] = f;
  ...
  p._events = s, p.listeners = function(n) {
    ...
    for (l = 0, a = d.length; a > l; l++) for (c = 0; g.length > c; c += u.length - 2) {
      ...
      else for (r in t) t[f](r) && u.push(t[r]);
      g.splice.apply(g, u)
    }
...
(function(t, e) {
    ...
    if (u) {
      if (l) l.initstatus = a, l.start = new Date - l.ms * a;
        ...
        case "transform":
          var E = r._,
            R = Oe(E[S], m[S]);
          if (R) for (v[S] = R.from, m[S] = R.to, y[S] = [], y[S].real = !0, w = 0, k = v[S].length; k > w; w++) for (y[S][w] = [v[S][w][0]], A = 1, P = v[S][w].length; P > A; A++) y[S][w][A] = (m[S][w][A] - v[S][w][A]) / x;
          else {
  ...
  e.color = function(t) {
    ...
    return e.is(t, W) && e.is(t[0], W) && (i = Fe(t)), i.length || M(t).replace(se, function(t, e, n) {
      ...
      else for (; a.length >= r[s] && (i.push([e][L](a.splice(0, r[s]))), r[s]););
  ...
  var Ce = e.pathBBox = function(t) {
      ...
      t = Re(t);
      for (var r, i = 0, a = 0, s = [], o = [], u = 0, l = t.length; l > u; u++) if (r = t[u], "M" == r[0]) i = r[1], a = r[2], s.push(i), o.push(a);
      else {
    ...
    Le = e._pathToAbsolute = function(t) {
      ...
      for (var h, c, f = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), p = l, d = t.length; d > p; p++) {
        ...
        else for (var m = 0, y = c.length; y > m; m++) h[m] = c[m];
        switch (h[0]) {
        case "Z":
          i = o, a = u;
          break;
  ...
  b.safari = "Apple Computer, Inc." == navigator.vendor && (Ve && 4 > Ve[1] || "iP" == navigator.platform.slice(0, 2)) || "Google Inc." == navigator.vendor && Ve && 8 > Ve[1] ?
  function() {
  ...
  var on = [],
    un = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
  function(t) {
    setTimeout(t, 16)
  }, ln = function() {
        ...
        if (i.initstatus ? (o = (i.initstatus * i.anim.top - i.prev) / (i.percent - i.prev) * u, i.status = i.initstatus, delete i.initstatus, i.stop && on.splice(r--, 1)) : i.status = (i.prev + (i.percent - i.prev) * (o / u)) / i.anim.top, !(0 > o)) if (u > o) {
          ...
          for (var m in h) if (h[B](m)) {
            ...
            case "path":
              ...
              break;
            case "transform":
              if (c[m].real) for (a = [], y = 0, b = h[m].length; b > y; y++) for (a[y] = [h[m][y][0]], _ = 1, w = h[m][y].length; w > _; _++) a[y][_] = h[m][y][_] + x * u * c[m][y][_];
              else {
                var k = function(t) {
  ...
  return fn.attr = function(t, n) {
    if (t && e.is(t, W) && e.is(t[0], "object")) for (var r = 0, i = t.length; i > r; r++) this.items[r].attr(t[r]);
    else for (var a = 0, s = this.items.length; s > a; a++) this.items[a].attr(t, n);
    return this
  }, fn.clear = function() {
    ...
    if (this.fonts[n] ? this.fonts[n].push(e) : this.fonts[n] = [e], !t.svg) {
      ...
      for (var i in t.glyphs) if (t.glyphs[B](i)) {
        ...
        }, a.k) for (var s in a.k) a[B](s) && (e.glyphs[i].k[s] = a.k[s])
      }
    }
    return t
  ...
  }, b.print = function(t, n, r, i, a, s, o, u) {
    s = s || "middle", o = z(O(o || 0, 1), -1), u = z(O(u || 1, 3), 1);
    var l, h = M(r)[I](P),
      c = 0,
      f = 0,
      p = P;
    if (e.is(i, "string") && (i = this.getFont(i)), i) {
      l = (a || 16) / i.face["units-per-em"];
      for (var d = i.face.bbox[I](_), g = +d[0], x = d[3] - d[1], v = 0, m = +d[1] + ("baseline" == s ? x + +i.face.descent : x / 2), y = 0, b = h.length; b > y; y++) {
        if ("\n" == h[y]) c = 0, k = 0, f = 0, v += x * u;
        else {
          var w = f && i.glyphs[h[y - 1]] || {},
            k = i.glyphs[h[y]];
          c += f ? (w.w || i.w) + (w.k && w.k[h[y]] || 0) + i.w * o : 0, f = 1
        }
        k && k.d && (p += e.transformPath(k.d, ["t", c * l, v * l, "s", l, l, g, m, "t", (t - g) / l, (n - m) / l]))
      }
    }
    ...
    var x = function(n, i) {
      ...
      C = function(n, a) {
        if ("text" == n.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
          ...
          } else for (f = o.getElementsByTagName("tspan"), p = 0, d = f.length; d > p; p++) p ? x(f[p], {
            dy: u * k,
            x: s.x
          }) : x(f[0], {
            dy: 0
      ...
      T = function(n, l) {
        ...
        if (x && (f.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (c.href = l.href), l.title && (c.title = l.title), l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || x) && (c.path = k(~r(f.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(f.path) : f.path), "image" == n.type && (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height], B(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), v) {
          var C = +f.cx,
            ...
            N = +f.rx || +f.r || 0,
            E = +f.ry || +f.r || 0;
          c.path = t.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((C - N) * b), a((T - E) * b), a((C + N) * b), a((T + E) * b), a(C * b))
        }
        if ("clip-rect" in l) {
        ...
        if ("arrow-start" in l && S(y, l["arrow-start"]), "arrow-end" in l && S(y, l["arrow-end"], 1), null != l.opacity || null != l["stroke-width"] || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
          ...
          if (P = P && P[0], !P && (I = P = L(h)), "image" == n.type && l.src && (P.src = l.src), l.fill && (P.on = !0), (null == P.on || "none" == l.fill || null === l.fill) && (P.on = !1), P.on && l.fill) {
            ...
            if (j) {
              ...
              circle: 1,
              ellipse: 1
            } || "r" != r(l.fill).charAt()) && A(y, l.fill, P) && (f.fill = "none", f.gradient = l.fill, P.rotate = !1)
          }
