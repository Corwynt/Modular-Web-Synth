    ...
    link: function(scope, elm, attrs, ngModel) {
      ...
      onChange = function(aEvent) {
        return function(instance, changeObj) {
          ...
          if (typeof aEvent === "function") aEvent(instance, changeObj);
        };
      };
      ...
      deferCodeMirror = function() {
        ...
        if (attrs.uiRefresh) {
          scope.$watch(attrs.uiRefresh, function(newVal, oldVal) {
            ...
            if (newVal !== oldVal) $timeout(codeMirror.refresh);
          });
        }
      };
  ...
  return function(mode, scope, elm, attrs) {
    ...
    elm.bind(mode, function(event) {
      ...
      angular.forEach(combinations, function(combination) {
        ...
        if (
        mainKeyPressed && (altRequired == altPressed) && (ctrlRequired == ctrlPressed) && (shiftRequired == shiftPressed)) {
          // Run the function
          scope.$apply(function() {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function($scope, elm, attrs) {
        ...
        function staticWatcher(newVal) {
          if ((hash = newVal.indexOf('#')) > -1) newVal = newVal.substr(hash + 1);
        ...
        case 'uiRoute':
          ...
          if (attrs.uiRoute) regexWatcher(attrs.uiRoute);
          else attrs.$observe('uiRoute', regexWatcher);
          break;
        case 'ngHref':
          // Setup watcher() every time ngHref changes
          if (attrs.ngHref) staticWatcher(attrs.ngHref);
          else attrs.$observe('ngHref', staticWatcher);
          break;
        case 'href':
          // Setup watcher()
    ...
    link: function(scope, element, attrs, ngModel) {
      ...
      if (ngModel) {
        ...
        opts.start = function(e, ui) {
          onStart(e, ui);
          if (typeof _start === "function") _start(e, ui);
        };
        ...
        opts.stop = function(e, ui) {
          onStop(e, ui);
          if (typeof _stop === "function") _stop(e, ui);
        };
        ...
        opts.update = function(e, ui) {
          onUpdate(e, ui);
          if (typeof _update === "function") _update(e, ui);
        };
        ...
        opts.receive = function(e, ui) {
          onReceive(e, ui);
          if (typeof _receive === "function") _receive(e, ui);
        };
        ...
        opts.remove = function(e, ui) {
          onRemove(e, ui);
          if (typeof _remove === "function") _remove(e, ui);
        };
      }
